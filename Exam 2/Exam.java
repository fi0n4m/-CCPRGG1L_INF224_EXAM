...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
      ...
      number1();
       ...
       // ==============================================================================
        ...
        String firstnameLength = scan.next();
        System.out.print("Enter your surname: ");
        String surnameLength = scan.next();
       
        number3(firstnameLength, surnameLength);
        ...
        // if BSCS
        case "BSCS":{
        System.out.print("Enter your specialization (DF) (ML): ");
        ...
        if (studentEmailAddress.contains("martinez")) {
    ...
    static void number3(String firstName, String surName){
        ...
        System.out.println("The sum of the character length of your firstName and your surName is: " + (firstnameLength + surnameLength));
    }
